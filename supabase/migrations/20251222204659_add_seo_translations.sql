-- Migration to add SEO and new translation keys
-- This migration adds all the new SEO metadata and translation keys that were added
-- for the SEO implementation, including meta titles, descriptions, and internal link text.
